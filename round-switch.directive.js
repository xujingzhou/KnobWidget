...
/*@ngInject*/
function RoundSwitchController($element, $scope, utils, types) { //, $log) {

   // test by johnny xu,2019/11/7
//   $log.log("---------------------- this is round switch ----------------------------");
//   $log.log('-----------------------this is round switch utils-----------------', utils);
//   $log.log('-----------------------this is round switch types-----------------', types);
